  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-item nav-link" style="font-family: 'Roboto Slab', serif;" href="projet.php">Accueil <span
  ...
  <form method="POST" action="projet.php">
    ...
    <table class="tab">
      ...
      <tr>
        ...
        <th rowspan="2"><button type="submit" class="btn btn-warning "
            style="margin-top: 25px;margin-left:auto;">Envoyer</button></th>
      </tr>
      <tr>
        ...
        while ($row = $stmt->fetch()) {
          ...
          <tr>
            ...
            <td>
              ...
              ?>
            <td><a href=download.php?id=<?php echo $row['fid'] ?> class="btn btn-outline-primary"><i
